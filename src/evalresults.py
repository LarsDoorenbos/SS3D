...
def eval_list(pred_file_list, label_file_list, mode="pixel"):
    ...
    return metrics.roc_auc_score(label_vals, pred_vals), metrics.average_precision_score(label_vals, pred_vals)
...
def eval_dir(pred_dir, label_dir, mode="pixel", save_file=None):
    ...
    AUCscore, APscore = eval_list(pred_file_list, label_file_list, mode=mode)
